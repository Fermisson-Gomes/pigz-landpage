...
function InfoContent() {
  ...
  return (
    <section onClick={handleClickChange}>
      <div>
        <div style={{backgroundColor: (visibleDiv === 1) ? "green" : "gray"}}>a</div>
        <div style={{backgroundColor: (visibleDiv === 2) ? "green" : "gray"}}>a</div>
        <div style={{backgroundColor: (visibleDiv === 3) ? "green" : "gray"}}>a</div>
        <div style={{backgroundColor: (visibleDiv === 4) ? "green" : "gray"}}>a</div>
      </div>
      {
        conteudo
      }
